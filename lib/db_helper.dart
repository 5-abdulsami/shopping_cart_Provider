...
class DBHelper {
  ...
  Future<List<Cart>> getCartList() async {
    var dbClient = await db;
    if (dbClient == null) {
      // Handle the case when dbClient is null
      // You might want to log an error, return an empty list, or throw an exception
      print('Error: dbClient is null');
      return [];
    }
